<template>
  <div class="container-fluid">
    ...
    <form @submit.prevent="create">
      ...
      <button
        @click.prevent="update" >Atualizar</button>
    </form>
  </div>
</template>
<script>
export default {
      ...
      .then((familias) => {
        ...
        this.$axios
          ...
          .then((structure) => {
            ...
            this.sobreCargaCategoriaId = this.structure.sobrecargaCategoria.code
            this.combinacaoAcoesVerificacaoDeFormacaoId = this.structure.combinacaoAcoesVerificacaoDeformacao.name
            this.projetoId = this.structure.projeto.id
            this.addedFamilias = this.structure.familias

            this.addedFamilias.forEach(familia => {
  ...
  methods: {
    ...
    update() {
      this.$axios
        .$put("http://localhost:8080/projetoEstruturas/api/structures/"+this.idStructure, {
          ...
          material: this.structure.material,
          neve: 1.0,
